package com.dulianbin.java.chatRoom.server;

import com.dulianbin.java.chatRoom.server.ChatServerHandler;
...
public class ChatServerInitialize extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        //pipeline.addLast("frame",new LengthFieldBasedFrameDecoder(42341324, 0, 4, 0, 4));
